...
What follows is a list of positive and negative aspects we identified.
...
Bad aspects:
 ...
 - There is almost no separate documentation available outside of the scenario and the JavaDoc comments themselves are lacking. Especially the interaction of components is not well explained. A solution to this problem could be a separate manual that explains these topics in greater detail or better JavaDoc.
